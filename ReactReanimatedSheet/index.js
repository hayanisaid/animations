...
const Lorem = () => (
  <View style={{ height: 500, backgroundColor: "green" }}>
    <Text>
      ...
      hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat. At vero
      eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias
      ...
      id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis
      debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a
  ...
  render() {
    return (
      <View style={styles.container}>
        <BottomSheet contentPosition={this.trans} snapPoints={[100, 400]} renderContent={this.renderInner} />
      </View>
    );
  }
}
